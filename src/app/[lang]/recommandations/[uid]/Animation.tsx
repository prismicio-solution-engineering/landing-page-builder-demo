  ...
  return (
    <div>
      <motion.svg
        ...
        className="w-1/6 max-w-[231px] h-auto absolute top-0 left-0 z-10 pointer-events-none hidden lg:block"
        ref={svgRef1}
      ...
      <motion.svg
        ...
        className="max-w-[271px] h-auto absolute top-0 right-0 z-10 pointer-events-none hidden lg:block"
        ref={svgRef2}
